...
include "categoryy.php";
include "Panierr.php";
include "orderr.php";

class Database {
    private $host = 'localhost';
    private $dbname = 'brief8_space';
...
class Users extends Database {
    ...
    public function getUsers(  $columns = '*', $where = '', $orderBy = '', $limit = 'all') {
        ...
        foreach ($usersData as $B) {
            ...
            $users[] = new Userr($B["id"],$B["name"],$B["prénom"],$B["phone"], $B["Email"],$B["adresse"],$B["ville"],$B["Password"],$B["is_Active"]);
        } 
        return $users;
...
class categories extends Database {
    ...
    public function getcategories( $columns = '*', $where = '', $orderBy = '', $limit = 'all') {
        ...
        foreach ($categoriesData as $B) {
            $categories[] = new categ($B["id"],$B["Nom"],$B["Description"],$B["img"],$B["deleted_at"]);
        } 
        return $categories;
...
class DetailsCommandes extends Database {
    ...
    public function getDetailsCommandes( $columns = '*', $where = '', $orderBy = '', $limit = 'all') {
        ...
        foreach ($DetailsCommandesData as $B) {
            $DetailsCommandes[] = new order($B["details_id"],$B["names"],$B["prix_total"],$B["commande_id"],$B["id_user"],$B["confirm_achter"],$B["created_at"]);      
          } 
